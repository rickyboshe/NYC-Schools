...
<img src="README_figs/README-analysis1-1.png" style="display: block; margin: auto;" />
...
<iframe src="https://public.tableau.com/views/NYCSocio-economicprofile/NYCSocio-economicProfile2?:language=en&amp;:display_count=yes&amp;:embed=yes&amp;:publish=yes&amp;" width="600" height="450">
...
<img src="README_figs/README-perform-1.png" style="display: block; margin: auto;" />
...
<img src="README_figs/README-perfrom2-1.png" style="display: block; margin: auto;" />
...
fig5<-survey_score_longer%>%ggplot(aes(x=respondent, y=avg_score, fill=respondent))+
  ...
  labs(title = "Perception of NYC schools quality (survey responsens)",
       y="Average rating",
       x="Respondent")+
  theme(plot.title = element_text(hjust = 0.5))

fig5<-ggplotly(fig5)
fig5<-hide_legend(fig5)
fig5
```

<img src="README_figs/README-rating-1.png" style="display: block; margin: auto;" />
Overall, parents seem to rate NYC schools the highest while students
(not surprisingly 😄) are rating the schools lowest. Teachers show the
most broad rating of NYC schools.

#### How respondents rate NYC schools on academic performance, communication, engagement and, safety and respect
...
<img src="README_figs/README-questions-1.png" style="display: block; margin: auto;" />
