...
```{r analysis1, include=TRUE, results='hide', message=FALSE, warning=FALSE, fig.align= "center", fig.width=7, fig.height=6, fig.path= "README_figs/README-"}
...
knitr::include_url("README_figs/Graph.html", height = "350px")
```
</center>
...
<iframe src="https://public.tableau.com/views/NYCSocio-economicprofile/NYCSocio-economicProfile2?:language=en&:display_count=yes&:embed=yes&:publish=yes" width = '600' height = '450'></iframe>
...
```{r analysis, include=TRUE, results='hide', message=FALSE, warning=FALSE, fig.align= "center", fig.width=7, fig.height=6,fig.path= "README_figs/README-" }
...
<center>
```{r, echo=FALSE, out.width="75%", fig.align="center"}
knitr::include_url("README_figs/relationship.html", height = "350px")
```
</center>
...
```{r perform, include=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.align= "center", fig.width=7, fig.height=6,fig.path= "README_figs/README-"}
...
<center>
```{r, echo=FALSE, out.width="75%", fig.align="center"}
knitr::include_url("README_figs/special.html", height = "350px")
```
</center>
...
An increase in the sahre of students learning to speak English is also related to lower academic performance for the school. Learning to speak English can be an indicator of share of students with a lower economic migrant background. 
<br><br>
```{r perfrom2, include=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.align= "center", fig.width=7, fig.height=6,fig.path= "README_figs/README-"}
...
<center>
```{r, echo=FALSE, out.width="75%", fig.align="center"}
knitr::include_url("README_figs/matrix.html", height = "350px")
```
</center>
...
```{r rating, include=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.align= "center", fig.width=7, fig.height=6,fig.path= "README_figs/README-"}
...
<center>
```{r, echo=FALSE, out.width="75%", fig.align="center"}
knitr::include_url("README_figs/survey.html", height = "350px")
```
</center>
...
```{r questions, include=TRUE, echo=TRUE, warning=FALSE, message=FALSE, fig.align= "center", fig.width=7, fig.height=6,fig.path= "README_figs/README-"}
...
<center>
```{r, echo=FALSE, out.width="75%", fig.align="center"}
knitr::include_url("README_figs/response.html", height = "350px")
```
</center>
